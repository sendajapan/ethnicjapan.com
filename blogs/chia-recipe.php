    ...
    <div class="row align-items-center mb-5">
      ...
      <div class="col-md-7 position-relative" data-aos="fade-right" data-aos-delay="200">
        <div class="about-image text-center">
          <img src="../assets/img/blog/blog1.webp" alt="Profile Image" class="img-fluid rounded-4 shadow-sm">
        </div>
      </div>
    </div>
      ...
      <div class="col-12 col-lg-3">
        <div class="card border bg-white shadow-sm p-3 rounded-2">
          ...
          <div class="body widget popular-post d-flex flex-column gap-3">
            ...
            <!-- Post 1 -->
            <a href="benefits_omega.php">
              <div class="card border-0 shadow-sm rounded-2 overflow-hidden">
                <img src="../assets/img/blog/blog3.webp" alt="Post Image" class="img-fluid" style="object-fit: cover; height: 150px; width: 100%;">
                <div class="p-3">
            ...
            <!-- Post 2 -->
            <a href="how_to_chia.php">
              <div class="card border-0 shadow-sm rounded-2 overflow-hidden">
                <img src="../assets/img/blog/blog2.webp" alt="Post Image" class="img-fluid" style="object-fit: cover; height: 150px; width: 100%;">
                <div class="p-3">
