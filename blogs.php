    ...
    <div class="row g-4 align-items-stretch" data-aos="fade-up" data-aos-delay="300">
      ...
      <div class="col-lg-6 col-md-6">
        <div class="portfolio-card h-100">
          <a href="<?=$base_url?>blog?chia-recipe" class="portfolio-link d-block h-100 text-decoration-none text-reset">
      ...
      <div class="col-lg-6 col-md-6">
        <div class="portfolio-card h-100">
          <a href="<?=$base_url?>blog?how-to-chia" class="portfolio-link d-block h-100 text-decoration-none text-reset">
            <div class="portfolio-image">
      ...
      <div class="col-lg-6 col-md-6">
        <div class="portfolio-card h-100">
          <a href="<?=$base_url?>blog?benefits-omega" class="portfolio-link d-block h-100 text-decoration-none text-reset">
            <div class="portfolio-image">
