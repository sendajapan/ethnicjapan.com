  ...
  <div class="container">
    <div class="row align-items-center mb-5">
      ...
      <div class="col-md-6 text-end">
        <img src="../assets/img/recipes/bowl.webp" alt="Bowl" style="width: 400px; height: auto;" class="img-fluid rounded-4 shadow-sm">
      </div>
    </div>
    ...
    <div class="row">
      ...
      <div class="col-lg-3">
        <div class="card p-4 rounded-4 shadow-sm border">
          ...
          <a href="chia_pudding_recipe.php">
            <div class="mb-3">
              <img src="../assets/img/recipes/chia_pudding.webp" class="img-fluid rounded-3 mb-2" alt="Chia Pudding">
              <p class="mb-1 fw-semibold">Chia Pudding</p>
            </div>
          </a>
