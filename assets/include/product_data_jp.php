...
$product_data = [
    ...
    'cacao' => [
        ...
        'content' => 'カカオは、その高い抗酸化物質の含有量と気分を高める特性で知られています。カカオは、心血管の健康や認知機能の改善を含む、深い健康効果をもたらします。'
    ],
    'quinoa' => [
    ...
    'adzuki-beans' => [
        ...
        'content' => 'アズキは、東アジア料理で人気のある小さな赤い豆です。タンパク質、食物繊維、そして必須ミネラルが豊富で、腎臓の健康をサポートし、体重管理や消化の改善に役立つことで知られています。'
    ],
    'amaranth' => [
    ...
    'sesame-seeds' => [
        ...
        'content' => 'ゴマの種は、健康的な脂肪、タンパク質、そしてさまざまなビタミンやミネラルを豊富に含んでいます。ゴマは、心臓の健康をサポートし、消化を改善し、優れたエネルギー源となります。'
    ],
    'maca-sacha-inchi' => [
        ...
        'content' => 'マカの根は、エネルギーを高め、ホルモンバランスを整える特性で知られており、サチャインチはオメガ3脂肪酸、タンパク質、食物繊維が豊富です。どちらも全体的な健康をサポートし、身体的なパフォーマンスを向上させ、精神的な明晰さを高めます。'
    ],
