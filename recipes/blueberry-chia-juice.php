...
<section class="section light-background py-5">
  <div class="container">
    <div class="row align-items-center mb-5">
      ...
      <?php $recipe = $data['blueberry-chia-juice']; ?>
      ...
      <div class="col-md-6 text-end">
        <img src="<?= $recipe['feature_img']; ?>" alt="Juice" style="width: 400px; height: auto;" class="img-fluid rounded-4 shadow-sm">
      </div>
    </div>
      ...
      <div class="col-lg-3">
        <div class="card p-4 rounded-4 shadow-sm border">
          ...
          <a href="<?=$base_url?>recipes/protein-smoothie">
            <div class="mb-3">
              <img src="<?=$base_url?>assets/img/recipes/smoothie.webp" class="img-fluid rounded-3 mb-2" alt="Smoothie">
          ...
          <a href="<?=$base_url?>recipes/shake">
            <div>
              <img src="<?=$base_url?>assets/img/recipes/shake.webp" class="img-fluid rounded-3 mb-2" alt="Shake">
