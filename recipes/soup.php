...
<section class="section light-background py-5">
  <div class="container">
    <div class="row align-items-center mb-5">
      ...
      <div class="col-md-6 text-center">
        ...
        <h2 class="fw-bold mb-3" style="font-size: 3rem;">Creamy Soup of Sprouted Lentils, Tomato and Olive Oil</h2>
        <p class="lead">That recipe for those who love flavors and creamy soups!</p>
      </div>
      <!-- Image Column -->
      <div class="col-md-6 text-end">
        <img src="<?=$base_url?>assets/img/recipes/soup.jpg" alt="Soup" style="width: 400px; height: auto;" class="img-fluid rounded-4 shadow-sm">
      </div>
    </div>
  ...
  <div class="col-6 col-md-3">
    <div class="rounded-3 p-3 pt-2 text-center h-100 bg-white shadow-sm" style="border-top: 4px solid #B66A50">
      ...
      <p class="mb-0 fw-semibold">30 mins</p>
    </div>
  </div>
  <div class="col-6 col-md-3">
    <div class="rounded-3 p-3 pt-2 text-center h-100 bg-white shadow-sm" style="border-top: 4px solid #B66A50">
      <h6 class="text-muted mb-1">Serving</h6>
      <p class="mb-0 fw-semibold">3 People</p>
    </div>
  </div>
  <div class="col-6 col-md-3">
    <div class="rounded-3 p-3 pt-2 text-center h-100 bg-white shadow-sm" style="border-top: 4px solid #B66A50">
      <h6 class="text-muted mb-1">Yield</h6>
      <p class="mb-0 fw-semibold">4 cups</p>
    </div>
  </div>
</div>
      ...
      <div class="col-lg-9 mb-4">
        <div class="bg-white p-4 rounded-4 shadow-sm" style="font-size: 1.1rem;">
          ...
          <ul class="mb-5 colored">
              <li class="mb-1" style="list-style-type: circle;">1 cup of Sprouted Lentils</li>
              <li class="mb-1" style="list-style-type: circle;">2 tbsp Chia Seeds</li>
              <li class="mb-1" style="list-style-type: circle;">2 cups of Tomato Juice (without sugar)</li>
              <li class="mb-1" style="list-style-type: circle;">1 tbsp of Olichia</li>
              <li class="mb-1" style="list-style-type: circle;">Salt and turmeric to taste</li>
          </ul>

          <h4 class="fw-semibold mt-4 mb-3">Instructions</h4>
          <ol class="mb-3 colored">
              <li class="mb-1">Blend all the ingredients in the blender, except the Olichia. </li>
              <li class="mb-1">Place the blended mixture in a pot and simmer for about 10 mins.</li>
              <li class="mb-1">Serve the cream warm (without boiling).</li>
              <li class="mb-1">Finish with a drizzle of the Olichia.</li>
          </ol>
        </div>
      </div>
      ...
      <div class="col-lg-3">
        <div class="card p-4 rounded-4 shadow-sm border">
          ...
          <a href="<?=$base_url?>recipes/ratatouille">
            <div class="mb-3">
              <img src="<?=$base_url?>assets/img/recipes/ratatouille.jpeg" class="img-fluid rounded-3 mb-2" alt="Ratatouille">
          ...
          <a href="<?=$base_url?>recipes/arugula-pesto">
            <div>
              <img src="<?=$base_url?>assets/img/recipes/arugula_pesto.webp" class="img-fluid rounded-3 mb-2" alt="Arugula Pesto">
